...
export const authService = {
  ...
  initiateFunding: (d) => api.post("/wallet/fund", d),
  forgotPassword: (d) => api.post("/auth/forgot-password", d),
  resetPassword: (d) => api.post("/auth/reset-password", d),
  createReservedAccount: () => api.post("/wallet/reserved-account"),
  createBillStackAccount: (d) => api.post("/wallet/billstack-account", d),
